    ...
    <div className="max-w-4xl mx-auto p-4 flex flex-col gap-4 ">
      ...
      {orderData?.shopOrders?.map((shopOrder, index) => (
        ...
        <div>
          ...
          <p className="flex justify-end"><span className="font-semibold">Total: </span>${shopOrder.subtotal}</p>
          <p className="mt-4">
          ...
          {shopOrder.status === "delivered" ? (
            ...
            {shopOrder.assignedShipper ? (
              <div className="text-sm">
                <p><span className="font-semibold">Shipper: </span>{shopOrder.assignedShipper.fullName}</p>
                <p><span className="font-semibold">Mobile: </span>{shopOrder.assignedShipper.mobile}</p>
              </div>
            ) : (
              <p className="text-red-600 font-semibold">Shipper Not Assigned Yet</p>
            )}
